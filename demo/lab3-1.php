...
/* overrrides for defaults in the config file config_inc.php
	...
	<form action="' . THIS_PAGE . '" method="post" onsubmit="return checkForm(this);">
		<table align="center">
			...
			<tr>
				...
				<td>
					<input type="text" name="player-name" /><font color="red"><b>*</b></font> <em>(alphabetic only)</em>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="player-team" /><font color="red"><b>*</b></font> <em>(alphabetic only)</em>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="player-tds" /><font color="red"><b>*</b></font> <em>(alphabetic only)</em>
				</td>
			</tr>
...
{#form submits here we show entered name
	...
	{//data must be sent	
		...
		myRedirect(THIS_PAGE);//forces user back to the form page
	}  
