...
#changed ---changed 02-02-15 jsr*******************************************

#Sessions are currently stored in a database via session_db_inc.php
ini_set('session.save_path','ftp://ftp.jeff-reynolds.com/itc250/sessions/'); #optional folder set to 0700 outside webroot to store session data
ini_set('session.cookie_domain', 'ftp://ftp.jeff-reynolds.com/itc250/cookies/'); # "dot" (period) then domain name - apply session cookies to subdomains, incl www!
#**************************************************************************
#----------------------------------------------------------------------
...
define('VIRTUAL_PATH', 'http://jeff-reynolds.com/itc250/wn15/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/home/jefrey9/jeff-reynolds.com/itc250/wn15//'); # Physical (PHP) 'root' of application for file & upload reference
define('INCLUDE_PATH', PHYSICAL_PATH . 'inc_0700/'); # Path to PHP include files - INSIDE APPLICATION ROOT
#changed ---changed 02-02-15 jsr*******************************************
http://www.jeff-reynolds.com/itc250/wn15/inc_0700/'); #Path to PHP include files - OUTSIDE WEB ROOT ---changed 02-02-15 jsr
#**************************************************************************
...
define('SUPPORT_EMAIL', '6turtleday@gmail.com'); # Email of site support
...
#changed ---added 02-02-15 jsr**************************************************************************
include INCLUDE_PATH . 'session_db_inc.php';
#**************************************************************************
# END INCLUDES (reference include files)---------------------------------------------------------------------

#changed ---addded 02-02-15 jsr********************************************
...
#define ('PREFIX', 'wn15_'); --threw error message:'Constant PREFIX already defined -- commented out to test 02-02-15 6:16PM
...
$config->slogan = 'Cotlets are pretty gross!';
$config->metaDescription = 'Welcome to the Cotlets website.  We split off from Applets. They are even more gross.';
$config->metaKeywords = 'Cotlets,Apricots,Turkish Delight,database,mysql,php';
$config->metaRobots = 'no index, no follow';
$config->banner = 'No Misspelled Cotlets please..'; #goes inside header - can be overwritten
