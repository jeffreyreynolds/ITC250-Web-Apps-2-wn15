...
ini_set('session.save_path','ftp://ftp.jeff-reynolds.com/sessions/'); #optional folder set to 0700 outside webroot to store session data
ini_set('session.cookie_domain', 'ftp://ftp.jeff-reynolds.com/cookies/'); # "dot" (period) then domain name - apply session cookies to subdomains, incl www!
...
define('VIRTUAL_PATH', 'http://www.jeff-reynolds.com/itc250/wn14/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', 'http://www.jeff-reynolds.com/itc250/wn14/'); # Physical (PHP) 'root' of application for file & upload reference
define('INCLUDE_PATH', PHYSICAL_PATH . 'inc_0700/'); # Path to PHP include files - INSIDE APPLICATION ROOT
//define('INCLUDE_PATH', 'http://www.jeff-reynolds.com/itc250/wn14/inc_0700/'); #Path to PHP include files - OUTSIDE WEB ROOT
...
define('SUPPORT_EMAIL', '6turtleday@gmail.com'); # Email of site support Zephir only will send to school emails
define('PREFIX', 'wn14_'); #Prefix to add uniqueness to your DB table names.  Limits hackability, naming collisions
